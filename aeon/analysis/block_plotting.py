...
def gen_subject_colors_dict(subject_names):
    """Generates a dictionary of subject colors for a given list of subject names."""
    return dict(zip(subject_names, subject_colors, strict=False))


def gen_patch_style_dict(patch_names):
    """Generates a dictionary containing patch style mappings for a given list of patch names.

    The returned dictionary contains the following mappings:
